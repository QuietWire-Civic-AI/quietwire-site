...
product, legal, authority, or adoption claims.

| Term | Governed form | Preferred Arabic | Review note |
| --- | --- | --- | --- |
| QuietWire | `QuietWire` | `QuietWire` / كوايت واير | Governed name; never translated as a new name. |
| CAP | `CAP` | `CAP` | No authoritative Arabic expansion. |
| Canonical Attestation Platform | `Canonical Attestation Platform` | المنصة المعيارية للتصديق | Provisional explanatory rendering. |
| QWOS | `QWOS` | `QWOS` | Governed identifier. |
...
| attestation | attestation | التصديق | Provisional. |
| appliance | appliance | جهاز العُقدة | Context-dependent; plural: أجهزة العُقَد. |
| mesh | mesh | الشبكة المترابطة | Provisional explanatory rendering. |

URLs, email addresses, hashes, `HTTPS`, `SHA-256`, `JSON`, technical
identifiers, and isolated numerals remain left-to-right where they appear.
